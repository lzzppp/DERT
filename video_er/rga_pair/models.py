...
from model_example import ResNetCommonBranch, init_pretrained_weights, model_urls, ResNet, Bottleneck
...
class mcan_reid(nn.Module):
    ...
    def forward(self, left, right, device):
        ...
        left_input_, right_input_ = self.resnet(left, right, device)
